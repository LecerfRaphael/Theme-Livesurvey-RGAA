...
<section id="notice-grand-public-4f-4g" style="max-width:900px;margin:auto;line-height:1.6;font-size:1rem;">
  ...
  <p>
    Les scripts <strong>4f</strong> et <strong>4g</strong> améliorent ce comportement dans LimeSurvey pour que
    <strong>tout soit plus clair et plus confortable</strong> pour les personnes qui répondent 😌
  </p>

  <hr>

  <h3>1️⃣ Réaffichage automatique des questions pertinentes</h3>

  <p>
    Parfois, LimeSurvey considère qu’une question doit être à nouveau affichée,
    mais elle reste pourtant cachée à l’écran 🤨.  
    Cela peut créer des blocages ou des situations incompréhensibles.
  </p>

  <p>Ce que fait le script 4f :</p>
  <ul>
    <li>👀 Il surveille les questions qui redeviennent “pertinentes”.</li>
    <li>🔄 Il les réaffiche automatiquement si elles étaient encore masquées.</li>
    <li>🧩 Il corrige les paramètres techniques pour que l’affichage et l’accessibilité soient cohérents.</li>
  </ul>

  <p>
    ✅ <strong>Résultat :</strong> plus de questions “fantômes” qui bloquent ou perturbent le répondant.
  </p>

  <hr>

  <h3>2️⃣ Gestion automatique des questions “Si oui…”</h3>

  <p>
    Le script 4g repère tout seul les questions qui commencent par
    <strong>“Si oui…”</strong> ou celles que l’on a marquées comme dépendantes.
    Elles sont alors reliées à la question juste avant.
  </p>

  <p>Ensuite, la règle est simple :</p>
  <ul>
    <li>✅ Si la réponse “Oui” est cochée à la question précédente → la question “Si oui…” apparaît.</li>
    <li>🚫 Si ce n’est pas le cas → la question “Si oui…” est masquée et ses réponses sont effacées.</li>
  </ul>

  <p>
    ✨ <strong>Résultat :</strong> la personne ne voit que les questions qui la concernent vraiment.
  </p>

  <hr>

  <h3>3️⃣ Nettoyage automatique des réponses masquées</h3>

  <p>
    Lorsqu’une question dépendante est cachée, le script ne se contente pas de la masquer visuellement.
    Il fait aussi un vrai nettoyage :
  </p>

  <ul>
    <li>🧹 Cases à cocher et boutons radio décochés.</li>
    <li>🔁 Listes déroulantes remises à leur première option.</li>
    <li>✏️ Champs texte et zones de commentaire vidés.</li>
    <li>❌ Obligation de répondre (champ “obligatoire”) supprimée sur ces questions masquées.</li>
  </ul>

  <p>
    ✅ <strong>Résultat :</strong> le questionnaire ne peut plus se bloquer à cause d’une ancienne réponse cachée.
  </p>

  <hr>

  <h3>4️⃣ Accessibilité renforcée ♿</h3>

  <p>
    Pour les personnes qui utilisent un clavier ou un lecteur d’écran,
    il est essentiel que les questions visibles / cachées soient bien signalées.
  </p>

  <p>Les scripts 4f et 4g veillent à :</p>
  <ul>
    <li>♿ Retirer les questions cachées de la navigation au clavier.</li>
    <li>🔊 Marquer correctement les questions visibles pour les lecteurs d’écran.</li>
    <li>🚫 Éviter les champs “obligatoires” qui ne seraient pas visibles.</li>
  </ul>

  <p>
    💚 Cela rend les questionnaires plus <strong>inclusifs</strong> et plus confortables pour tout le monde.
  </p>

  <hr>

  <h3>5️⃣ Une expérience plus fluide pour les répondants</h3>
  ...
  <p>
    En résumé, les scripts <strong>4f</strong> et <strong>4g</strong> permettent de proposer des
